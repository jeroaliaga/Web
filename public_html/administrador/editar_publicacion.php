<?php
	...
	$includes_array = array('navigation.php','editar_publicacion.php');
	...
	if(isset($_POST['action']) && $_POST['action']=='DoSave'){
		include($ruta_raiz."includes/procesos/DoSave.php");
	} else {
	...
	if($totalRows_R_section==0 || $totalRows_R_info_publicacion==0){
		if($totalRows_R_info_publicacion==0){
