<?php
	...
	$includes_array = array('navigation.php','eliminar_usuario.php');
	...
	if(isset($_POST['action']) && $_POST['action']=='DoEliminarPerfil'){
		include($ruta_raiz."includes/procesos/DoEliminarPerfil.php");
	}
