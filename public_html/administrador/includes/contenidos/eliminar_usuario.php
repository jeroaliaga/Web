            ...
            <div class="row">
                <div class="col-lg-12">
					<h1 class="page-header">
						Está a punto de eliminar el usuario <?php echo $row_R_list_usuarios['nombre']; ?><?php if($row_R_list_usuarios['apellido']){ echo ' '.$row_R_list_usuarios['apellido']; } ?>
						<br/>¿Desea continuar?
					</h1>
                </div>
                <!-- /.col-lg-12 -->
									...
									<div class="row">
										<div class="col-lg-6">
												<div class="form-group">
													<label>Nombre</label>
													<input disabled name="nombre" class="form-control" type="text" value="<?php echo $row_R_list_usuarios['nombre']; ?>" required>
												</div>
												<div class="form-group">
													<label>Apellido</label>
													<input disabled name="apellido" class="form-control" type="text" value="<?php echo $row_R_list_usuarios['apellido']; ?>" required>
												</div>
												<div class="form-group">
													<label>Email</label>
													<input disabled name="email" class="form-control" type="text" value="<?php echo $row_R_list_usuarios['email']; ?>" required>
												</div>
										</div>
										<!-- /.col-lg-6 (nested) -->
										<div class="col-lg-6">
												...
												<div class="form-group">
													<label>Estado</label>
													<select disabled class="form-control" name="active">
										...
										<div class="col-lg-12">
											...
											<input type='hidden' name="action" value="DoEliminarPerfil" />
											<input type='submit' name="submit_guardar_password" class="btn btn-primary btn-lg btn-block" value="Si! eliminar" />
										</div>
									</div>
									<!-- /.row (nested) -->
								</div>
