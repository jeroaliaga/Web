<?php
	...
	if($page_title=='' || $page_content==''){
		...
		$query="INSERT into publicaciones (id, page_title, page_content, page_type, page_author, permalink, hoy_ahora, img, active, tags, parent, menu_parent, target) 
		VALUES(NULL, '".$page_title."', '$page_content', '".$page_type."', '".$page_author."', '".$permalink."', '".$hoy_ahora."', '".$img."', '".$active."', '".$tags."', '".$parent."', '".$menu_parent."', '".$target."'); ";
