<?php
	...
	include($ruta_raiz."includes/sitematrix/gral_data.php");
		...
		$includes_array = array('navigation.php','bloque_head.php', 'bloque_mi-perfil.php','footer.php');
	...
	if(isset($_POST['action']) && $_POST['action'] == 'DoCerrarCuenta'){
		include($ruta_raiz."includes/procesos/DoCerrarCuenta.php");
		$DoCerrarCuenta = TRUE;
	}
